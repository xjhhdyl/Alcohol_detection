...
genres = 'intoxicate  sober'.split()
for g in genres:
    pathlib.Path(f'melspectrogram/{g}').mkdir(parents=True, exist_ok=True)
    for filename in os.listdir(f'./WAV/{g}'):
        songname = f'./WAV/{g}/{filename}'
...
if __name__ == '__main__':
    src_data_folder = "D:\Research_projects\Alcohol_detection\melspectrogram"
    target_data_folder = "D:\Research_projects\Alcohol_detection\meldataset"
